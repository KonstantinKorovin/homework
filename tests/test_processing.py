...
@pytest.mark.parametrize("list_dict_filter, state, expected", [
    ([{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'}],
...
@pytest.mark.parametrize("data_sort_dict, date_sort, expected",[
    ([{'id': 1, 'state': 'Ex', 'date': '2018-06-31..'}, {'id': 2, 'state': 'Ex', 'date': '2018-07-30..'}], True,
     [{'id': 2, 'state': 'Ex', 'date': '2018-07-30..'}, {'id': 1, 'state': 'Ex', 'date': '2018-06-31..'}]),

    ([{'id': 1, 'state': 'Ex', 'date': '2018-06-31..'}, {'id': 2, 'state': 'Ex', 'date': '2018-07-30..'}], False,
